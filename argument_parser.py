...
def parser(logger):
    ...
    parser.add_argument('--template_type', type=str, default="SQUARE", choices=["SPHERE", "SQUARE"],
                        help='dim_out_patch')
    parser.add_argument("--remove_all_batchNorms", action="store_true", default=True, help="Replace all batchnorms by identity")
    ...
    opt.dim_template = dim_template_dict[args.template_type]
