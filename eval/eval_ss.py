...
def main(args):
	...
	print('Number of sampled instances is {}'.format(sample_train_ptcloud_set.shape[0]))
	...
	## report 
	print('Experiment No.{} point cloud silhouette: '.format(args.experiment_number), pt_ss)
	print('Experiment No.{} img silhouette: '.format(args.experiment_number), img_ss)
	print('Time:{:3} seconds'.format(time.time() - starter_time))
