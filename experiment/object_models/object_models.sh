...
# 						  --lambda-loss-fine 1. \
# 						  --mode $MODE \
# 						  --output-dir 'atlasnet_sphere/' \
# 						  --snapshot-dir 'atlasnet_sphere/' \
# 						  --log-dir	'atlasnet_sphere/'	\
# 						  --lr-G $LR \
# 						  --momentum $MOMENTUM \
# 						  --weight-decay $WEIGHTDECAY \
# 						  --lr_decay_step $DECAYSTEP \
...
# 						  --lambda-loss-fine 1. \
# 						  --mode $MODE \
# 						  --output-dir 'atlasnet_4patch_rmBN/' \
# 						  --snapshot-dir 'atlasnet_4patch_rmBN/' \
# 						  --log-dir	'atlasnet_4patch_rmBN/'	\
# 						  --lr-G $LR \
# 						  --momentum $MOMENTUM \
# 						  --weight-decay $WEIGHTDECAY \
# 						  --lr_decay_step $DECAYSTEP \
...
# 						  --lambda-loss-fine 1. \
# 						  --mode $MODE \
# 						  --output-dir 'foldingres6_rp2/' \
# 						  --snapshot-dir 'foldingres6_rp2/' \
# 						  --log-dir	'foldingres6_rp2/'	\
# 						  --lr-G $LR \
# 						  --momentum $MOMENTUM \
# 						  --weight-decay $WEIGHTDECAY \
# 						  --lr_decay_step $DECAYSTEP \
