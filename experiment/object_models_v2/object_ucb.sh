...
CUDA2=0                                # gpu id for model  atlasnet lr=6  4 square
CUDA3=2                                # gpu id for model  atlasnet 1r=2  8 square
CUDA4=3                                # gpu id for model  atlasnet 1r=2  8 square
...
CUDA_VISIBLE_DEVICES=$CUDA4 python ../../train.py \
                          ...
                          --lr_decay_step $DECAYSTEP \
                          --weight-decay $WEIGHTDECAY \
						  --log-dir	'atlasnet_object_4square_lr2_random_bbox/'  `# logging Info`\
						  --tensorboard \
						  `# --save-results `\
						  --test \
						  --train 
