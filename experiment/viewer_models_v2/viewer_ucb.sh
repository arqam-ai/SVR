...
NUM_WORKER=4                 
# CUDA 
CUDA1=3                                # gpu id for model  atlasnet lr=6  4 square
CUDA2=1                                # gpu id for model  atlasnet lr=2  4 square
CUDA3=1                                # gpu id for model  atlasnet lr=2  4 square repeat1
CUDA4=1                                # gpu id for model  atlasnet lr=2  4 square repeat1
...
# model4 atlasnet BN hidden 2 batch size = 64
CUDA_VISIBLE_DEVICES=$CUDA2 python ../../train.py \
                          ...
                          --lr_decay_step $DECAYSTEP \
                          --weight-decay $WEIGHTDECAY \
						  --log-dir	'atlasnet_viewer_4square_lr2_random_ucb/'  `# logging Info`\
						  --tensorboard \
						  --test \
						  --generate-mesh
#						  --train 
...
# atlasnet lr=2  4 square repeat1
...
#                           --lr_decay_step $DECAYSTEP \
#                           --weight-decay $WEIGHTDECAY \
# 						  --log-dir	'atlasnet_viewer_4square_lr2_random_ucb_1/'  `# logging Info`\
# 						  --tensorboard \
# 						  --test \
# 						  --train 
...
#                           --lr_decay_step $DECAYSTEP \
#                           --weight-decay $WEIGHTDECAY \
# 						  --log-dir	'atlasnet_viewer_4square_lr2_random_bbox/'  `# logging Info`\
# 						  --tensorboard \
# 						  `#--save-results` \
# 						  --test \
# 						  --train 
